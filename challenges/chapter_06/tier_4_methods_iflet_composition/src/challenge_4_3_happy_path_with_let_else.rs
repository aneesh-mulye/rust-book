...
mod tests {
    ...
    fn computes_bmi_when_both_inputs_exist() {
        ...
        assert!((bmi - 22.857142857142858).abs() < 1e-10, "BMI should be about 22.8571. Got {bmi}.");
        assert_eq!(classify_bmi(bmi), "normal", "BMI around 22.9 should classify as normal.");
    }

    #[test]
    fn returns_none_when_any_input_is_missing() {
        assert_eq!(compute_bmi(None, Some(1.80)), None, "Missing weight should return None.");
        assert_eq!(compute_bmi(Some(90.0), None), None, "Missing height should return None.");
    }

    #[test]
    fn bmi_categories_follow_standard_thresholds() {
        assert_eq!(classify_bmi(17.5), "underweight", "BMI 17.5 should be underweight.");
        assert_eq!(classify_bmi(24.0), "normal", "BMI 24.0 should be normal.");
        assert_eq!(classify_bmi(27.0), "overweight", "BMI 27.0 should be overweight.");
